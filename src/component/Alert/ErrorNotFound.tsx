...
const ErrorNotFound: React.FC = ()  => {
  ...
  return (
    <section className="flex items-center  justify-center relative z-10 pb-16 pt-36 md:pb-20 lg:pb-28 lg:pt-[180px]">
        ...
        <div className="flex flex-wrap -mx-4">
            ...
            <div className="mx-auto max-w-[530px] text-center">
                ...
                <Link
                href="/"
                className="px-8 py-3 text-base font-bold text-muted-foreground duration-300 rounded-md bg-[#4a7dff]/10 shadow-signUp hover:bg-white hover:text-[#4a7dff] md:px-9 lg:px-8 xl:px-9"
                >
                Back to Homepage
                </Link>
            </div>
